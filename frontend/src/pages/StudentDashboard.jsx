...
import { getRiskScores, getInterventions } from "../api/otherAPIs";
    ...
    <div style={{ display: "flex", minHeight: "100vh", background: "#0a0e1a" }}>
      ...
      <main style={{ flex: 1, padding: "32px", overflowY: "auto" }}>
          ...
          <div style={{ flexShrink: 0 }}>
            <ResponsiveContainer width={110} height={110}>
              <RadialBarChart
                ...
                innerRadius={32}
                outerRadius={50}
                data={[{ value: risk?.score || 0, fill: riskColor }]}
                startAngle={90}
                endAngle={-270}>
                <RadialBar
                  dataKey="value"
          ...
          <div style={{ flex: 1 }}>
            ...
            <div
              ...
              <span
                style={{
                  ...
                  fontWeight: "900",
                  lineHeight: 1,
                  textShadow: `0 0 24px ${riskColor}77`,
                }}>
            ...
            <div style={{ color: "#475569", fontSize: "12px" }}>
              {risk
                ...
                : "Mark attendance to generate score"}
            </div>
          </div>
          {risk && (
            <div style={{ display: "flex", gap: "12px", flexShrink: 0 }}>
              {[
                {
                  label: "Attendance",
                  value: `${risk.attendance_pct?.toFixed(0)}%`,
                  color: "#38bdf8",
                },
                {
                  label: "Grade Avg",
                  value: `${risk.grade_avg?.toFixed(0)}`,
                  color: "#10b981",
                },
                ...
                <div
                  ...
                  <div
                    style={{
                      ...
                      fontSize: "20px",
                      fontWeight: "800",
                      textShadow: `0 0 12px ${f.color}77`,
                    }}>
                    {f.value}
                  </div>
                  <div
        ...
        <div
          ...
          <div
            style={{
              background: "linear-gradient(145deg, #131929, #0d1520)",
              border: "1px solid #1e2d45",
              borderRadius: "14px",
              padding: "20px",
                ...
                <PieChart>
                  <Pie
                    ...
                    {attendancePieData.map((_, i) => (
                      <Cell
                        key={i}
                        fill={ATTEND_COLORS[i]}
                        style={{
                          filter: `drop-shadow(0 0 6px ${ATTEND_COLORS[i]}99)`,
                        }}
                      />
                    ))}
                  </Pie>
                  ...
                  <Pie
                    ...
                    {gradesPieData.map((_, i) => (
                      <Cell
                        ...
                        fill={GRADE_COLORS[i]}
                        style={{
                          filter: `drop-shadow(0 0 6px ${GRADE_COLORS[i]}99)`,
                        }}
                      />
                    ))}
                  </Pie>
            ...
            {[
              {
                ...
                value: `${attendancePct}%`,
                color: attendancePct >= 75 ? "#10b981" : "#ef4444",
                icon: "📋",
              },
              {
                label: "Grade Average",
                value: `${gradeAvg}%`,
                color: gradeAvg >= 50 ? "#10b981" : "#ef4444",
                icon: "📝",
              },
              {
                label: "Passing Grades",
                value: `${passingGrades}/${grades.length}`,
                color: "#38bdf8",
                icon: "✅",
              },
              {
                ...
                color: incidents.length > 2 ? "#ef4444" : "#64748b",
                icon: "⚠️",
              },
            ].map((s) => (
              <div
            ...
            {incidents.map((inc, i) => (
              <div
                ...
                style={{
                  ...
                  alignItems: "center",
                  borderBottom:
                    i < incidents.length - 1 ? "1px solid #1e2d45" : "none",
                }}>
                <div>
                  <span
                    style={{
